const strings = {
  "pt-br": {
    ...
    "Are you sure you want to change from INLINE to EXTENDED?":
      "Você tem certeza que quer mudar de LINEAR para EXTENDIDA?",
    "You need to be logged in in order to record audio clips":
      "Você precisa estar logado para gravar trilhas",
    "You need to stop recording in order to activate any other track":
      "Você precisa parar sua gravação para ativar outra trilha",
    "Are you sure you wanna publish this audio description?":
      "Você tem certeza que quer publicar essa áudio descrição?",
    "Are you sure you wanna unpublish this audio description?":
      "Você tem certeza que quer despublicar essa áudio descrição?",
    "Are you sure you want to delete the audio description? This will remove all recorder tracks and cannot be undone":
      "Você tem certeza que quer remover essa áudio descrição? Isso removerá todas as trilhas e não poderá ser desfeito",
    "Authoring is not available on this screen size. Please use a larger screen to add a description":
      "A ferramenta de edição não está disponível para o seu tamanho de tela. Use uma resolução maior",
    Loading: "Carregando",
    ...
    "Add an inline audio description track which plays concurrently with the video's audio":
      "Adiciona uma trilha linear que irá ser reproduzida junto com o áudio do vídeo",
    "Add an extended audio description track which pauses the video as it plays and then resumes the video when it finishes":
      "Adiciona uma trilha extendida que irá pausar o vídeo para ser reproduzida. Assim que terminar, o vídeo voltará a ser reproduzido",
    ...
    "Unlabeled saved track": "Trilha sem nome",
    "Label for this track": "Nome desta trilha",
    "Add inline": "+ linear",
    "Add extended": "+ extendida",
    "Use this space as your notepad while you are recording all your descriptions tracks.":
      "Utilize este espaço como um bloco de notas para fazer anotações que ajudarão na gravação das áudio descrições.",
    "Please rate this description with 1 star being unusable and 5 stars being perfect":
      "Avalie esta áudio descrição sendo que 1 estrela é igual a péssima e 5 estrelas perfeita",
    "Thanks for rating this description!": "Obrigado pela avaliação!",
    "Thank you for your feedback!": "Obrigado pelo retorno!",
    "Optional feedback": "Avaliação adicional",
    "Please give additional feedback to help describers make adjustments":
      "Contribua com essa avaliação adicional para ajudar os áudio descritores a fazerem ajustes",
    ...
    "Do not step on the dialogue": "Descrições em cima de diálogos do vídeo",
    "Needs less description": "Precisa de menos descrição",
    ...
    "A step-by-step audio description tutorial with a trouble shooting section":
      "Tutorial passo-a-passo para [audio descritores",
    SUPPORT: "SUPORTE",
    "It is not possible to vote again for this video.":
      "Não é possível votar novamente neste vídeo.",
  ...
  "en-us": {
    ...
    Notes: "Notes",
    Language: "Language",
    "Audio description language": "Audio description language",
    "Unlabeled saved track": "Unlabeled saved track",
    "Label for this track": "Label for this track",
    ...
    "Do not step on the dialogue": "Do not step on the dialogue",
