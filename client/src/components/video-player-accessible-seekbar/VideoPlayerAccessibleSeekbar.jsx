    ...
    return (
      <div className="seekbar">
        <div id="seekbar-slider-rail" className="seekbar-slider-rail floatLeft">
          <button className="seekbar-slider-thumb" id="seekbar-slider-thumb1" role="slider" aria-labelledby="sliderLabel" aria-valuemin="0" aria-valuemax="100" aria-valuenow="50" aria-valuetext="50%" accessKey="j"></button>
        </div>
      </div>
    );
  }
