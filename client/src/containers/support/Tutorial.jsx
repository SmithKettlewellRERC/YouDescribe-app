      ...
      <div id="support" tabIndex="-1">
        ...
        <main className="w3-row">
          ...
          <p>
            ...
            tool box, center-left of page. The video must be up at YouTube for
            you to add description. (If it has not been shared at YouTube, you
            can create a channel of your own to upload the content you want.
            Directions supplied{" "}
          ...
          <p>
            <strong>Wish List</strong>: YouDescribe keeps a wish list of videos
            in need of AD. To find something on the wish list, click the Wish
            List button at the top tool bar, it has a heart next to it. Now you
            are on the main Wish List page. Videos with more votes for AD are at
            the top, the latest wish list requests are at the bottom. Select a
            video to describe from the wish list by clicking the Describe button
            in the lower right hand corner of the video thumbnail. If you want
            to vote a video to the top of the wish list queue, click the heart
            in the lower left hand corner of the video thumbnail. Don’t see
            anything you like? Try clicking the Load More button, bottom center
            of page, to see the next page of wish list items. Click the
            thumbnail to select the video and start adding AD.
          </p>

          <h3>Adding something to the wish list:</h3>
          <p>
            At YouDescribe, use the search box. The videos will appear as thumb
            nails. In the left hand corner of each video on the screen is a
            heart. Click the heart to add it to the wish list. There is not
            currently a way to add a video to the wish list if it has been
            opened in YouDescribe. Try going back to the search results page
            with the thumbnails, and click the heart icon in the lower left
            corner.
          </p>
          ...
          <p>
            ...
            If the video does not already have AD, there will be Add Description
            ...
            description allows you to rate the describer on that particular
            video. Turn Off descriptions allows you to stop the AD while you
            view the video. Videos may have multiple descriptions available). To
            begin - select Add Description. You can add description to any
            video- even if it has already been described.
          </p>

          <h3>Anatomy of the YouDescribe AD tools.</h3>
          <p>
            The video is in the upper left corner with standard YouTube play
            pause buttons. Stop/start is controlled by the standard YouTube tool
            bar on the video in the left hand corner. On the right is a section
            labeled Notes. Under the video is a long tool bar. At the far left
            of the tool bar are two buttons, a yellow Add Inline button, and a
            magenta Add extended. Inline is an audio track that plays over the
            video, it needs to be timed so as not to disrupt the dialog, and
            original audio. Extended description stops the video while the AD is
            played. Even with extended description, it is best to say only as
            much as it strictly necessary so the viewer can get back to watching
            the video. You will need to be familiar with both the YouTube
            play/pause buttons, as well as the YouDescribe tool bars.
          </p>
          ...
          <p>
            ...
            proceed to other steps. Often it is the title shown on the screen,
            or a brief description of the setting.
          </p>
          ...
          <p>
            ...
            the label box there are two symbols- a red record button, and a
            trash can. Mouse up to the controls on the video, and press play.
            Get the curser ready to click the red record button under the
            Extended audio track you have set up. When you want to record your
            first track, click the red record button. Once you have clicked the
            red button, it will be replaced with a white square. This is now the
            stop recording button. Click the white square when you are done
            speaking. Use the control buttons on the video to back up and hear
            your first track. If you are happy with it, press the save button.
            To delete a recorded track, click the trash can button. Now you can
            re-record your anchor track. Once you are happy with it, press save.
            It is best practice not to delete your anchor track once you are
            satisfied.
          </p>
          ...
          <p>
            ...
            towards the bottom of the audio tracks. Click that save button
            before you delete anything, or refresh the video.
          </p>
          ...
          <p>
            ...
            be converted from Extended to Inline using the rightwards arrow over
          ...
          <p>
            ...
            click it as many times as you need to get it to settle in exactly
            the right spot. Play the video to hear if it is just right by using
            the control panel located on the video (the regular YouTube
            controls), then save your work by pressing the save button in the
            lower right corner. Save your work often.
          </p>
          ...
          <p>
            A: First of all, make sure that your mic is turned on, your
            computer’s mic settings are un-muted, and the mic volume is turned
            up. You can test you mic using a number of online programs.{" "}
            <a href="https://www.onlinemictest.com/">Here is one</a>. YouTube
            and YouDescribe are sometimes misaligned and the tracks play out of
            sync, especially if you have used the delete, nudge, or
            inline/extended edit tools. They are usually still there! Save your
            work by pressing the save button, then refresh the page - your
            tracks should now play. If you are on a very slow connection, or are
            running a lot of programs sometimes there is a lag in processing and
            saving your tracks. One thing that can help is shutting down any
            unneeded applications, getting to a better internet or waiting a few
            more seconds after pressing save before moving onto the next task.
          </p>
          ...
          <p>
            A: Most description that has been created over the last few decades
            is Inline description. This means that the description is carefully
            ...
            leading to extremely hard choices about what they could describe.
            With streaming video available on demand, it is no longer necessary
            to restrict the available time for description. Extended description
          ...
          <h3>
            Q: I recorded an inline track but it is too long and is getting in
            the way of the dialog. Help!
          </h3>
          <p>
          ...
          <h3>
            Q: I made a lot of extended tracks an now the video is super long,
            and boring.
          </h3>
          <p>
            A: It happens to the best of us. We want to be thorough and get
            everything in there! Chances are the video is a little over
            described. Try cutting down your script, and re-recording a few
            tracks.
          </p>

          <h3>Q: I missed a section I needed to describe, how do I fix it?</h3>
          <p>
            A: Save your work, then refresh the video so you can play it from
            the beginning. At the bottom, label the track you want to record.
            Advance the video until you are in the right spot and click the red
            dot to start recording, click the white square when you are finished
            speaking. The tag for the track will not be in play order, but it
            will play in the correct spot on the video.
          </p>
