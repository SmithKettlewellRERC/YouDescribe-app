  ...
  <ul>
    <li>
      <Link to="/support/about">
        {props.translate("General information about YouDescribe")}
      </Link>
    </li>
    <li>
      <Link to="/support/viewers">
        {props.translate("FAQ pages for viewers")}
      </Link>
    </li>
    <li>
      <Link to="/support/describers">
        {props.translate("FAQ for describers")}
      </Link>
    </li>
    <li>
