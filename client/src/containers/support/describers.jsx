      ...
      <div id="support" tabIndex="-1">
        ...
        <main className="w3-row">
          ...
          <p>
            ...
            wire, or connection). There are several programs that will check
            your microphone.
          </p>
          ...
          <p>
            <strong>6.</strong> Don't "spot-check" your tracks by skipping
            around, in general your recorded tracks are there, but the API cant
            keep up the synchronized play with rapid changes.
          </p>
          ...
          <h3>
            Q: Do I need any kind of training or certification to be a
            YouDescribe describer?
          </h3>
          <p>
            A: No, but the more you know about good audio description, the
            better and more useful your descriptions will be. Go to{" "}
            <a href="https://www.youtube.com/playlist?list=PLNJrbI_nyy9uzywoJfyDRoeKA1SaIEFJ7">
              Description Tutorial Playlist
            </a>{" "}
          ...
          <p>
            ...
            . At YouDescribe you will be prompted to type in your google
            address, and password. Once you have logged in, you are ready to
            start rating videos, and doing audio description (AD).
          </p>
          ...
          <p>
            ...
            that people need. Let your blind students, friends, and family
            members be the guides. YouDescribe keeps a wish list of videos in
            need of AD. To find something on the wish list, click the Wish List
            button at the top tool bar, it has a heart next to it. Now you are
            on the main Wish List page. Videos with more votes for AD are at the
            top, the latest wish list requests are at the bottom. Select a video
            to describe from the wish list by clicking the Describe button in
            the lower right hand corner of the video thumbnail. If you want to
            vote a video to the top of the wish list queue, click the heart in
            the lower left hand corner of the video thumbnail. Don’t see
