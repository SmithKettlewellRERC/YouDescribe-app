      ...
      <div id="support" tabIndex="-1">
        ...
        <main className="w3-row">
          ...
          <p>
            ...
            going on in a video can benefit from descriptions recorded by
            sighted describers, but other viewers like individuals on the autism
            spectrum, or those learning a new language can benefit from AD as
            well. Descriptions can be contributed by anyone with the time,
            skill, and inclination, including parents, teachers, and friends and
            fans. Many people may just think YouDescribe is cool and want to try
            it.{" "}
          </p>
          ...
          <p>
            ...
            equivalent. For example, when someone demonstrating a yoga pose
            says, “Hold your arms like this,” or a crafting demonstrator says,
            “Glue this piece like this,” the blind viewer is barred from using
            that video as a learning tool. On-screen text, scene changes, and
            body language are all video elements that may need some description
            in order for a blind viewer to follow a story. Adding description
            makes video accessible. That’s important!
          </p>
          ...
          <p>
            A: Sighted people view YouTube videos and record descriptions of
            what they see. When the video is played with YouDescribe, the
            descriptions are played back with the video. Underneath the hood,
            YouDescribe uses an exclusive API to store description clips and
            information about them. YouDescribe knows what video each clip
            belongs to and what time the clip should be played. Lots of other
            information is stored along with the descriptions, including who
            recorded it, when it was recorded, how popular it is, etc.
            YouDescribe is the first video service to allow anybody, anywhere,
            to record and upload video descriptions to the cloud. It provides a
            unique way for people to get descriptions for the instructional,
            informational, and entertainment videos offered on YouTube.
          </p>
          ...
          <p>
            A: No. The video must be up at YouTube for you to add description.
            If it has not been shared at YouTube, you can create a channel of
            your own to upload the content you want. Directions supplied at:{" "}
          ...
          <p>
            ...
            title of any of the videos listed. The most recently described
            videos appear at the top of the list. Find any video by using the
            search field on this page. While videos with descriptions are listed
            first, search results will yield undescribed videos as well. Just
            click on the title to play the video you want to watch.
          </p>
          ...
          <p>
            ...
            ). At www.youdescribe.org you will be prompted to type in your
            google address, and password. Once you have logged in, you are ready
            to start rating videos, and doing audio description (AD).
          </p>
          ...
          <p>
            ...
            system. Currently, YouDescribe is not compatible on mobile devices
            but they are in the works and will be launched very soon.
          </p>
          ...
          <p>
            A: Sharing can be done in a couple of ways. On the left of every
            video is a quick share link for email, Facebook, and twitter. It
            generates an easy to share template for each social media platform.
            To share on a webpage one can copy the web address from the browser
            field at the top and use iframe or an object tag to embed the
            desired video.
          </p>
