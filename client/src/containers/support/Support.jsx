    ...
    return (
      <div id="support" tabIndex="-1">
        ...
        <main className="w3-row">
          ...
          <h2><a name="viewers" className="anchor">For Viewers</a></h2>
          ...
          <h2><a name="describers" className="anchor">For Describers</a></h2>
          ...
          <h2><a name="tutorial" className="anchor">Ready to get started? We have a step-by-step tutorial for new users!</a></h2>

          <p>YouDescribe Audio Description (AD) Tool Step By Step Instructions</p>
