...
class SummaryOfTimeRange extends Component {
        ...
        topVideos.push(
          <div key={item._id}>
            <Link to={"/video/" + item._id}
              target={item._id}>{item.video.title}
            </Link>
          </div>
        );
      });
  ...
  loadCountOfFeedbacks(startDate, endDate) {
    ...
    ourFetchWithToken(url).then((response) => {
      ...
      items.forEach(feedback => {
        feedbacks.push(
          <div key={feedback._id}>{conf.audioDescriptionFeedbacks[feedback._id]}</div>
        );
      });
      this.setState({
        feedbacks: feedbacks,
  ...
  getRoute(type) {
    return `/statistics/dailycountofdatarecords?type=${encodeURIComponent(type)}&startdate=${this.state.startDate}&enddate=${this.state.endDate}`;
  }
    ...
    return (
      <div className="admin-responsive">
        ...
        <main className="w3-row">
          <div style={{textAlign: "center", fontSize: 20}}><b>Summary Of Time Range</b></div>
          ...
          <tbody>
            <tr>
              ...
              <th>
                ...
                <Link to={this.getRoute("Video Visits")} target="daily">View Daily Count</Link>
              </th>
            </tr>
            <tr>
              <th>Count Of Web Visits</th>
              <th>
                {this.state.webVisits}&nbsp;
                <Link to={this.getRoute("Web Visits")} target="daily">View Daily Count</Link>
              </th>
            </tr>
            <tr>
              ...
              <th>
                {this.state.users}&nbsp;
                <Link to={this.getRoute("Users")} target="daily">View Daily Count</Link>
              </th>
            </tr>
            <tr>
              ...
              <th>
                ...
                <Link to={this.getRoute("Audio Clips")} target="daily">View Daily Count</Link>
              </th>
            </tr>
            <tr>
              ...
              <th>
                ...
                <Link to={this.getRoute("Audio Descriptions")} target="daily">View Daily Count</Link>
              </th>
            </tr>
            <tr>
              ...
              <th>
                ...
                <Link to={this.getRoute("Videos")} target="daily">View Daily Count</Link>
              </th>
            </tr>
            <tr>
              ...
              <th>
                {this.state.words}&nbsp;
                <Link to={this.getRoute("Words")} target="daily">View Daily Count</Link>
              </th>
            </tr>
            <tr>
